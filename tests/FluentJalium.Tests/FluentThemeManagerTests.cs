...
public sealed class FluentThemeManagerTests
{
    ...
    public void Apply_ShouldInsertFluentDictionariesOnlyOnce()
    {
        ...
        try
        {
            ...
            AssertBasedOnStyle<FWMicaAltSurface, Border>(app.Resources);
            AssertBasedOnStyle<FWAcrylicSurface, Border>(app.Resources);
            AssertBasedOnStyle<FWFrostedGlassSurface, Border>(app.Resources);
            AssertBasedOnStyle<FWCardSurface, Border>(app.Resources);
            AssertBasedOnStyle<FWFlyoutSurface, Border>(app.Resources);
    ...
    public void GenericTheme_ShouldLoadFromPackPathAndExposeCoreControlStyles()
    {
        ...
        AssertContainsStyle<FWMicaAltSurface>(dictionary);
        AssertContainsStyle<FWAcrylicSurface>(dictionary);
        AssertContainsStyle<FWFrostedGlassSurface>(dictionary);
        AssertContainsStyle<FWCardSurface>(dictionary);
        AssertContainsStyle<FWFlyoutSurface>(dictionary);
        AssertContainsStyle<FWFocusGlassSurface>(dictionary);
