...
public static class FluentThemeManager
{
    ...
    private static void AddFluentControlStyleAliases(ResourceDictionary dictionary)
    {
        ...
        AliasStyle<FWDiffViewer, DiffViewer>(dictionary);
        AliasStyle<FWHexEditor, HexEditor>(dictionary);
        AliasStyle<FWJsonTreeViewer, JsonTreeViewer>(dictionary);
    ...
    private static ResourceDictionary BuildAccentDictionary(Color accent)
    {
        ...
        return new ResourceDictionary
        {
            ...
            ["ToggleCheckedBackground"] = new SolidColorBrush(accent),
            ["ToggleCheckedBackgroundHover"] = new SolidColorBrush(hover),
            ["ToggleCheckedBorder"] = new SolidColorBrush(accent),
            ["ToggleCheckedBorderHover"] = new SolidColorBrush(hover),
            ["ToggleSwitchOnBackground"] = new SolidColorBrush(accent),
            ["ToggleSwitchOnBackgroundHover"] = new SolidColorBrush(hover),
            ["ToggleSwitchOnBorder"] = new SolidColorBrush(accent),
            ["ToggleSwitchOnBorderHover"] = new SolidColorBrush(hover),
            ["SliderTrackValueFill"] = new SolidColorBrush(accent),
            ["SliderTrackValueFillPointerOver"] = new SolidColorBrush(hover),
            ["SliderTrackValueFillPressed"] = new SolidColorBrush(pressed),
            ["SliderTrackValueFillDisabled"] = new SolidColorBrush(disabled),
            ["SliderThumbBackground"] = new SolidColorBrush(accent),
            ["SliderThumbBackgroundPointerOver"] = new SolidColorBrush(hover),
            ["SliderThumbBackgroundPressed"] = new SolidColorBrush(pressed),
            ["SliderThumbBackgroundDisabled"] = new SolidColorBrush(disabled),
            ["ProgressBarForeground"] = new SolidColorBrush(accent),
            ["ProgressBarIndeterminateBackground"] = new SolidColorBrush(hover),
            ["ProgressBarDisabledForeground"] = new SolidColorBrush(disabled),
            ["ShapeFill"] = new SolidColorBrush(Color.FromArgb(CurrentTheme == FluentThemeVariant.Dark ? (byte)0x33 : (byte)0x26, accent.R, accent.G, accent.B)),
            ["ShapeFillPointerOver"] = new SolidColorBrush(Color.FromArgb(CurrentTheme == FluentThemeVariant.Dark ? (byte)0x4D : (byte)0x33, hover.R, hover.G, hover.B)),
            ["ShapeFillPressed"] = new SolidColorBrush(Color.FromArgb(CurrentTheme == FluentThemeVariant.Dark ? (byte)0x40 : (byte)0x2E, pressed.R, pressed.G, pressed.B)),
            ["ShapeFillDisabled"] = new SolidColorBrush(disabled),
            ["ShapeStroke"] = new SolidColorBrush(accent),
            ["ShapeStrokePointerOver"] = new SolidColorBrush(hover),
            ["ShapeStrokePressed"] = new SolidColorBrush(pressed),
            ["ShapeStrokeDisabled"] = new SolidColorBrush(disabled),
            ...
            ["ComboBoxBorderBrushFocused"] = new SolidColorBrush(accent),
