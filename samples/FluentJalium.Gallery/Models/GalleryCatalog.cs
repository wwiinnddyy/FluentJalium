...
internal static class GalleryCatalog
{
    public static GalleryPage[] Create(GalleryPageContentFactories content)
    {
        ...
        [
            ...
            new GalleryPage("Motion and Transitions", "Connected animation and shared element motion for FluentJalium navigation continuity.", GalleryNavigationGroup.MaterialsAndMotion, FluentIconRegular.SlideTransition24, content.MotionAndTransitions, "FWConnectedAnimationService connected animation shared element motion transition continuity navigation suppress entrance drill in slide"),
