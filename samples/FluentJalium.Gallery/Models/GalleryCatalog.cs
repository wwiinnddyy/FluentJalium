...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWContentDialog FWTaskDialog FWGroupBox dialog tooltip expander task dialog settings group box disclosure panel SettingsExpander settings row rows item items host ItemsHost collection grouped nested settings card SettingsCard WinUI Fluent CommunityToolkit WPFUI material liquid glass", IsUpdated: true, SourcePath: "/Disclosure/FWSettingsExpander", BaseClasses: ["Expander", "ContentControl"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWSettingsExpander", "FWSettingsCard", "FWExpander", "FWGroupBox", "FWContentDialog", "FWTaskDialog", "FWToolTip"], SampleCodeKey: "disclosure.settingsexpander"),
        ...
        Entry("status", GalleryNavigationGroup.AppStructure, FluentIconRegular.AlertBadge24, "FWInfoBar FWInfoBadge FWSnackbar FWToastNotificationHost FWToastNotificationItem FWStatusBar FWStatusBarItem notification message severity snackbar toast queue max visible status bar item material liquid glass operations", IsUpdated: true, SourcePath: "/Status/FWSnackbar", BaseClasses: ["ContentControl", "Control"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWSnackbar", "FWInfoBar", "FWInfoBadge", "FWToastNotificationHost", "FWStatusBar"], SampleCodeKey: "status.snackbar"),
