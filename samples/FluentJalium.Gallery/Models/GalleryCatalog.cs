...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWContentDialog FWTaskDialog FWGroupBox dialog tooltip expander task dialog ShowAsync awaitable result default button cancel button closing closed settings group box disclosure panel SettingsExpander settings row rows item items host ItemsHost collection grouped nested settings card SettingsCard WinUI Fluent CommunityToolkit WPFUI FluentAvalonia material liquid glass", IsUpdated: true, SourcePath: "/Disclosure/FWTaskDialog", BaseClasses: ["ContentControl", "Expander"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTaskDialog", "FWSettingsExpander", "FWSettingsCard", "FWExpander", "FWGroupBox", "FWContentDialog", "FWToolTip"], SampleCodeKey: "disclosure.taskdialog"),
