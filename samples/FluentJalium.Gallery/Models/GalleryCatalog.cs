...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("collections", GalleryNavigationGroup.CollectionsAndData, FluentIconRegular.Table24, "FWListBox FWListView FWGridView FWGridViewItem FWTreeView FWDataGrid FWTreeDataGrid table list data grid gridview hierarchy selection material liquid glass row height headers WinUI GridView", IsUpdated: true, SourcePath: "/Collections/FWGridView", BaseClasses: ["ListBox", "ListView", "ListViewItem", "GridView", "DataGrid"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWListBox", "FWListView", "FWGridView", "FWGridViewItem", "FWTreeView", "FWDataGrid", "FWTreeDataGrid"], SampleCodeKey: "collections.gridview"),
        ...
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWTeachingTip FWContentDialog FWTaskDialog FWGroupBox dialog tooltip teaching tip teachingtip expander task dialog ShowAsync awaitable result default button cancel button closing closed target placement tail hero action settings group box disclosure panel SettingsExpander settings row rows item items host ItemsHost collection grouped nested settings card SettingsCard WinUI Fluent CommunityToolkit WPFUI FluentAvalonia material liquid glass", IsUpdated: true, SourcePath: "/Disclosure/FWTeachingTip", BaseClasses: ["ContentControl", "Expander"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTeachingTip", "FWTaskDialog", "FWSettingsExpander", "FWSettingsCard", "FWExpander", "FWGroupBox", "FWContentDialog", "FWToolTip"], SampleCodeKey: "disclosure.teachingtip"),
