...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("advancedinteraction", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.Filter24, "FWRefreshContainer FWRefreshContainerDiagnostics FWScroller FWScrollerViewportDiagnostics FWAnnotatedScrollBar pull refresh request deferral progress visualizer diagnostics scroller snap annotated scrollbar advanced interaction viewport offset extent scroll viewer", GalleryPageStatus.Preview, IsUpdated: true, SourcePath: "/Interaction/FWScroller", BaseClasses: ["ContentControl", "ScrollBar"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWRefreshContainer", "FWRefreshContainerDiagnostics", "FWScroller", "FWScrollerViewportDiagnostics", "FWAnnotatedScrollBar", "FWScrollViewer"], SampleCodeKey: "advancedinteraction.scroller"),
