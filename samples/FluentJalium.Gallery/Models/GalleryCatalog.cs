...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWContentDialog FWTaskDialog FWGroupBox dialog tooltip expander task dialog settings group box disclosure material liquid glass panel", IsUpdated: true, SourcePath: "/Disclosure/FWTaskDialog", BaseClasses: ["ContentControl", "Expander"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTaskDialog", "FWSettingsExpander", "FWContentDialog", "FWExpander", "FWToolTip"], SampleCodeKey: "disclosure.taskdialog"),
