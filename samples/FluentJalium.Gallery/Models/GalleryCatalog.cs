...
internal static class GalleryCatalog
{
    public static GalleryPage[] Create(GalleryPageContentFactories content)
    {
        ...
        [
            ...
            new GalleryPage("Switches", "ToggleButton and ToggleSwitch states for checked, unchecked, indeterminate, and disabled surfaces.", GalleryNavigationGroup.ControlSurfaces, FluentIconRegular.ToggleMultiple24, content.Switches, "FWToggleButton FWToggleSwitch checked unchecked indeterminate"),
            ...
            new GalleryPage("Materials and Effects", "Window backdrops, backdrop effects, and WinUI-style material layering for FluentJalium surfaces.", GalleryNavigationGroup.MaterialsAndEffects, FluentIconRegular.TransparencySquare24, content.MaterialsAndEffects, "WindowBackdropType SystemBackdrop Mica MicaAlt Acrylic BackdropEffect BlurEffect AcrylicEffect MicaEffect FrostedGlassEffect DropShadowEffect material layer reveal HLSL shader liquid glass connected animation"),
