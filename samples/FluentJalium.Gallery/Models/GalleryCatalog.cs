...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("advancedcollections", GalleryNavigationGroup.CollectionsAndData, FluentIconRegular.AppFolder24, "FWItemsRepeater items repeater viewport scroll source range realization recycling diagnostics layout stack grid cache estimated item extent advanced collections first wave", GalleryPageStatus.Preview, IsNew: true, SourcePath: "/Collections/FWItemsRepeater", BaseClasses: ["Panel", "FrameworkElement"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWItemsRepeater", "FWScrollViewer", "FWListView", "FWTreeView", "FWDataGrid"], SampleCodeKey: "advancedcollections.itemsrepeater"),
