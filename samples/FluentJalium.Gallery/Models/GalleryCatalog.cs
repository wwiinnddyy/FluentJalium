...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("contentandlayout", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.LayoutColumnTwo24, "FWTextBlock FWAccessText FWCanvas FWBorder FWContentControl FWContentPresenter FWStackPanel FWWrapPanel FWGrid FWRelativePanel FWTwoPaneView FWParallaxView FWSettingsCard FWTransitioningContentControl layout content host adaptive settings row rows SettingsCard Click Command CanExecute CommandParameter ClickMode Hover action keyboard invocation settings page value material liquid glass WinUI Fluent CommunityToolkit WPFUI ActualMode VisiblePane Diagnostics Progress CurrentOffset adaptive diagnostics parallax progress offset", IsUpdated: true, SourcePath: "/Layout/FWTwoPaneView", BaseClasses: ["ContentControl", "Control", "Panel", "Grid", "FrameworkElement"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTwoPaneView", "FWParallaxView", "FWSettingsCard", "FWSettingsExpander", "FWContentControl", "FWStackPanel", "FWGrid", "FWButton"], SampleCodeKey: "layout.settingscard"),
        ...
        Entry("advancedcollections", GalleryNavigationGroup.CollectionsAndData, FluentIconRegular.AppFolder24, "FWItemsRepeater items repeater range realization recycling diagnostics layout stack grid cache advanced collections first wave", GalleryPageStatus.Preview, IsNew: true, SourcePath: "/Collections/FWItemsRepeater", BaseClasses: ["Panel", "FrameworkElement"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWItemsRepeater", "FWListView", "FWTreeView", "FWDataGrid"], SampleCodeKey: "advancedcollections.itemsrepeater"),
        ...
        Entry("navigation", GalleryNavigationGroup.AppStructure, FluentIconRegular.Navigation24, "FWNavigationView FWNavigationViewItem FWNavigationViewItemHeader FWNavigationViewItemSeparator FWBreadcrumbBar FWPipsPager FWSelectorBar FWSelectorBarItem FWTabView FWTabViewItem FWTitleBar FWTitleBarButton pane display mode LeftCompact LeftMinimal Top hierarchy breadcrumb trail pips pager page index selector selectorbar tab tabview titlebar title bar shell app shell window chrome back forward material liquid glass", IsUpdated: true, SourcePath: "/Navigation/FWNavigationView", BaseClasses: ["NavigationView", "Frame", "Control", "Selector", "TabItem", "ContentControl", "TitleBar"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWNavigationView", "FWNavigationViewItem", "FWNavigationViewItemHeader", "FWNavigationViewItemSeparator", "FWFrame", "FWBreadcrumbBar", "FWPipsPager", "FWSelectorBar", "FWSelectorBarItem", "FWTabView", "FWTabViewItem", "FWTitleBar", "FWTitleBarButton"], SampleCodeKey: "navigation.breadcrumb.pips.selector.tabview.titlebar"),
        ...
        Entry("menus", GalleryNavigationGroup.AppStructure, FluentIconRegular.List24, "FWMenuBar FWMenu FWContextMenu FWMenuFlyout FWMenuFlyoutItem FWToggleMenuFlyoutItem FWMenuFlyoutSubItem FWMenuFlyoutSeparator FWCommandBarFlyout command menu flyout submenu shortcut primary secondary commandbar material liquid glass workbench", IsUpdated: true, SourcePath: "/Menus/FWMenuFlyout", BaseClasses: ["Menu", "MenuItem", "ContextMenu", "FlyoutBase"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWMenuBar", "FWMenu", "FWContextMenu", "FWMenuFlyout", "FWMenuFlyoutItem", "FWMenuFlyoutSubItem", "FWCommandBarFlyout"], SampleCodeKey: "menus.flyout.commandbar"),
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWTeachingTip FWContentDialog FWTaskDialog FWTaskDialogHost FWTaskDialogHostDiagnostics FWTaskDialogHostKeyboardRequest FWGroupBox dialog tooltip teaching tip teachingtip expander task dialog modal host overlay ShowAsync awaitable result default button cancel button light dismiss focus restore focus trap keyboard diagnostics LastKeyboardRequest TabForward TabBackward closing closed PrimaryButtonCommand SecondaryButtonCommand CloseButtonCommand CommandExecuted CanExecute Escape focus visibility enabled target placement tail hero action settings group box disclosure panel SettingsExpander settings row rows item items host ItemsHost ItemCount ItemsChanged AddSetting ClearSettings ContentProperty collection grouped nested settings card SettingsCard WinUI Fluent CommunityToolkit WPFUI FluentAvalonia material liquid glass", IsUpdated: true, SourcePath: "/Disclosure/FWTaskDialog", BaseClasses: ["ContentControl", "Expander"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTaskDialog", "FWTaskDialogHost", "FWTaskDialogHostDiagnostics", "FWSettingsExpander", "FWSettingsCard", "FWTeachingTip", "FWExpander", "FWGroupBox", "FWContentDialog", "FWToolTip"], SampleCodeKey: "disclosure.taskdialog"),
