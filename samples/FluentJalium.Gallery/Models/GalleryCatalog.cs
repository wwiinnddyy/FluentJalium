...
internal static class GalleryCatalog
{
    public static GalleryPage[] Create(GalleryPageContentFactories content)
    {
        ...
        [
            ...
            new GalleryPage("Materials and Effects", "Window backdrops, backdrop effects, material roles, and WinUI-style layering for FluentJalium surfaces.", GalleryNavigationGroup.MaterialsAndMotion, FluentIconRegular.TransparencySquare24, content.MaterialsAndEffects, "WindowBackdropType SystemBackdrop Mica MicaAlt Acrylic BackdropEffect BlurEffect AcrylicEffect MicaEffect FrostedGlassEffect DropShadowEffect material role shell layer transient focused reveal HLSL shader liquid glass recipe preset"),
