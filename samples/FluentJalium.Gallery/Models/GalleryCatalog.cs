...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("advancedinteraction", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.Filter24, "FWRefreshContainer FWScroller FWScrollerViewportDiagnostics FWAnnotatedScrollBar pull refresh scroller snap annotated scrollbar advanced interaction viewport diagnostics offset extent scroll viewer", GalleryPageStatus.Preview, IsUpdated: true, SourcePath: "/Interaction/FWScroller", BaseClasses: ["ContentControl", "ScrollBar"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWRefreshContainer", "FWScroller", "FWScrollerViewportDiagnostics", "FWAnnotatedScrollBar", "FWScrollViewer"], SampleCodeKey: "advancedinteraction.scroller"),
