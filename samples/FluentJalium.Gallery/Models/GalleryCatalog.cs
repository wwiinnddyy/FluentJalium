...
internal static class GalleryCatalog
{
    public static GalleryPage[] Create(GalleryPageContentFactories content)
    {
        ...
        [
            ...
            Page("Range", "Slider, RangeSlider, ProgressBar, and ProgressRing controls with live values, snapped ranges, and material progress states.", GalleryNavigationGroup.Input, FluentIconRegular.Gauge24, content.Range, "FWSlider FWRangeSlider FWProgressBar FWProgressRing value loading progress ring range snap tick vertical material"),
            ...
            Page("Window Backdrops", "DWM-backed shell materials for Jalium windows, including Mica, Mica Alt, Acrylic, and solid shell fallback.", GalleryNavigationGroup.Materials, FluentIconRegular.WindowBrush24, content.WindowBackdrops, "FWFluentWindowBackdropKind FWFluentWindowBackdropRecipe WindowBackdropType SystemBackdrop DWM Mica MicaAlt Acrylic solid shell window backdrop material"),
            Page("Materials and Effects", "Element backdrops, material roles, and WinUI-style layering for FluentJalium surfaces.", GalleryNavigationGroup.Materials, FluentIconRegular.TransparencySquare24, content.MaterialsAndEffects, "FWFluentMaterialSurface FWFluentMaterialKind FWFluentMaterialRecipe BackdropEffect BlurEffect AcrylicEffect MicaEffect FrostedGlassEffect DropShadowEffect material role layer transient focused reveal HLSL shader liquid glass recipe preset"),
            Page("Motion and Transitions", "Connected animation, shared element motion, and FW content transitions for FluentJalium navigation continuity.", GalleryNavigationGroup.Motion, FluentIconRegular.SlideTransition24, content.MotionAndTransitions, "FWConnectedAnimationService FWTransitioningContentControl connected animation shared element motion content transition continuity navigation suppress entrance drill in slide crossfade liquid morph"),
            Page("Menus", "MenuBar, Menu, ContextMenu, MenuFlyout, and CommandBarFlyout surfaces with submenu, shortcut, and LiquidGlass workbench states.", GalleryNavigationGroup.AppStructure, FluentIconRegular.List24, content.Menus, "FWMenuBar FWMenu FWContextMenu FWMenuFlyout FWMenuFlyoutItem FWToggleMenuFlyoutItem FWMenuFlyoutSubItem FWMenuFlyoutSeparator FWCommandBarFlyout command menu flyout submenu shortcut material liquid glass workbench"),
            Page("Disclosure", "Expander, ToolTip, ContentDialog, and GroupBox controls with command states and LiquidGlass disclosure panels.", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, content.Disclosure, "FWExpander FWToolTip FWContentDialog FWGroupBox dialog tooltip expander group box disclosure material liquid glass panel"),
            Page("Status", "InfoBar, InfoBadge, ToastNotification, and StatusBar controls with severity, queue, and material operation states.", GalleryNavigationGroup.AppStructure, FluentIconRegular.AlertBadge24, content.Status, "FWInfoBar FWInfoBadge FWToastNotificationHost FWToastNotificationItem FWStatusBar FWStatusBarItem notification message severity toast queue max visible status bar item material liquid glass operations"),
            Page("State Matrix", "Cross-control normal, selected, disabled, and flyout state checks.", GalleryNavigationGroup.Diagnostics, FluentIconRegular.DataUsage24, content.StateMatrix, "states normal hover pressed selected disabled light dark high contrast", GalleryPageStatus.Diagnostic, IsFooter: true)
        ];
    }
