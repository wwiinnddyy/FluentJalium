...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("disclosure", GalleryNavigationGroup.AppStructure, FluentIconRegular.PanelLeft24, "FWExpander FWSettingsExpander FWToolTip FWTeachingTip FWContentDialog FWTaskDialog FWGroupBox dialog tooltip teaching tip teachingtip expander task dialog ShowAsync awaitable result default button cancel button closing closed target placement tail hero action settings group box disclosure panel SettingsExpander settings row rows item items host ItemsHost ItemCount ItemsChanged AddSetting ClearSettings ContentProperty collection grouped nested settings card SettingsCard WinUI Fluent CommunityToolkit WPFUI FluentAvalonia material liquid glass", IsUpdated: true, SourcePath: "/Disclosure/FWSettingsExpander", BaseClasses: ["ContentControl", "Expander"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWSettingsExpander", "FWSettingsCard", "FWTeachingTip", "FWTaskDialog", "FWExpander", "FWGroupBox", "FWContentDialog", "FWToolTip"], SampleCodeKey: "disclosure.settings.teachingtip"),
