...
internal static class GalleryCatalog
{
    ...
    [
        ...
        Entry("resources", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Document24, "resources resourcedictionary staticresource themeresource fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("styles", GalleryNavigationGroup.Fundamentals, FluentIconRegular.PaintBrush24, "styles implicit explicit style setter fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("binding", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Link24, "binding xbind data context fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("templates", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Grid24, "templates datatemplate controltemplate itemspanel fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("customusercontrols", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Window24, "custom user controls templated usercontrol fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("xamlconditions", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Code24, "xaml conditions conditional namespace contract fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("scratchpad", GalleryNavigationGroup.Fundamentals, FluentIconRegular.Beaker24, "scratch pad playground experiment fundamentals WinUI", GalleryPageStatus.Preview),
        Entry("screenreadersupport", GalleryNavigationGroup.Accessibility, FluentIconRegular.Person24, "accessibility screen reader narrator automation name help text WinUI", GalleryPageStatus.Preview),
        Entry("keyboardsupport", GalleryNavigationGroup.Accessibility, FluentIconRegular.Keyboard24, "accessibility keyboard tab focus accelerator shortcut WinUI", GalleryPageStatus.Preview),
        Entry("colorcontrast", GalleryNavigationGroup.Accessibility, FluentIconRegular.Eye24, "accessibility color contrast high contrast ratio WinUI", GalleryPageStatus.Preview),
        ...
        Entry("textinput", GalleryNavigationGroup.Input, FluentIconRegular.Textbox24, "FWTextBox PasswordBox FWNumberBox FWAutoCompleteBox FWAutoSuggestBox FWRichTextBox AutoSuggestTextChanged QuerySubmitted SuggestionChosen LastTextChangeReason TextChangeReason search form input password number step autocomplete autosuggest suggestions rich text material WinUI AutoSuggestBox", IsUpdated: true, SourcePath: "/TextInput/FWAutoSuggestBox", BaseClasses: ["TextBox", "AutoCompleteBox", "RichTextBox"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTextBox", "PasswordBox", "FWNumberBox", "FWAutoCompleteBox", "FWAutoSuggestBox", "FWRichTextBox"], SampleCodeKey: "textinput.autosuggestbox"),
        Entry("selection", GalleryNavigationGroup.Input, FluentIconRegular.CheckboxChecked24, "FWCheckBox FWRadioButton FWRadioButtons FWComboBox FWComboBoxItem FWRatingControl RatingControl pick choose select all three state radio group editable star rating material", IsUpdated: true, SourcePath: "/Selection/FWRadioButtons", BaseClasses: ["Selector", "ItemsControl"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWCheckBox", "FWRadioButton", "FWRadioButtons", "FWComboBox", "FWComboBoxItem", "FWRatingControl"], SampleCodeKey: "selection.radiobuttons"),
        Entry("forms", GalleryNavigationGroup.Input, FluentIconRegular.FormMultiple24, "forms validation required fields submit reset label alignment autosuggest suggestions radio grouped choices infobar settings card settings rows toggle switch density app pattern scenario workflow", IsNew: true, SourcePath: "/Patterns/Forms", BaseClasses: ["FWStackPanel", "ContentControl", "Selector", "Control"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWLabel", "FWTextBox", "FWAutoSuggestBox", "FWRadioButtons", "FWInfoBar", "FWSettingsCard", "FWToggleSwitch", "FWButton", "FWCheckBox"], SampleCodeKey: "patterns.forms"),
        ...
        Entry("contentandlayout", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.LayoutColumnTwo24, "FWTextBlock FWAccessText FWCanvas FWBorder FWContentControl FWContentPresenter FWStackPanel FWWrapPanel FWGrid FWRelativePanel FWSplitView FWSplitViewDiagnostics FWTwoPaneView FWTwoPaneViewDiagnostics FWParallaxView FWParallaxViewDiagnostics FWSettingsCard FWSettingsCardDiagnostics FWSettingsCardAutomationPeer FWSettingsCardAutomationDiagnostics FWTransitioningContentControl layout content host splitview pane adaptive settings row rows SettingsCard Click Command CanExecute CommandParameter ClickMode Hover action keyboard invocation invoke pattern automation peer automation diagnostics IsInvokable IsInteractionPressed Name HelpText settings page value material liquid glass WinUI Fluent CommunityToolkit WPFUI IsPaneOpen DisplayMode PanePlacement OpenPaneLength CompactPaneLength ActualPaneLength CompactInline CompactOverlay IsOverlayMode IsLightDismissEnabled HasPane HasContent Diagnostics ActualMode VisiblePane Progress CurrentOffset SourceKind SourceOrientation ScrollViewer FWScroller adaptive diagnostics parallax progress offset scroll source", IsUpdated: true, SourcePath: "/Layout/FWSplitView", BaseClasses: ["ContentControl", "Control", "Panel", "Grid", "FrameworkElement"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWTextBlock", "FWAccessText", "FWCanvas", "FWBorder", "FWContentControl", "FWContentPresenter", "FWStackPanel", "FWWrapPanel", "FWGrid", "FWRelativePanel", "FWSplitView", "FWSplitViewDiagnostics", "FWTwoPaneView", "FWTwoPaneViewDiagnostics", "FWParallaxView", "FWParallaxViewDiagnostics", "FWScroller", "FWSettingsCard", "FWSettingsCardDiagnostics", "FWSettingsCardAutomationPeer", "FWSettingsCardAutomationDiagnostics", "FWSettingsExpander", "FWButton"], SampleCodeKey: "layout.splitview.settingscard"),
        Entry("visuals", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.Image24, "FWImage FWBitmapIcon FWImageIcon FWRichTextBlock FWFontIcon FWSymbolIcon FWPathIcon FWLabel FWSeparator FWViewbox FWPersonPicture FWMarkdown FWQRCode FWRectangle FWEllipse FWLine FWPolyline FWPolygon FWPath FluentIcon icon library regular filled visual image stretch zoom label separator viewbox rich text markdown avatar person picture profile initials badge qr qrcode barcode shape rectangle ellipse line polyline polygon path geometry fill stroke material liquid glass", IsUpdated: true, SourcePath: "/Visuals/FWPersonPicture", BaseClasses: ["Image", "TextBlock", "Control", "Markdown", "QRCode", "Shape"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWPersonPicture", "FWMarkdown", "FWQRCode", "FWRectangle", "FWEllipse", "FWLine", "FWPolyline", "FWPolygon", "FWPath", "FWImage", "FWBitmapIcon", "FWImageIcon", "FWRichTextBlock", "FWFontIcon", "FWSymbolIcon", "FWPathIcon", "FWLabel", "FWSeparator", "FWViewbox"], SampleCodeKey: "visuals.icons.richtext.personpicture.markdown.qrcode.shapes"),
        Entry("interaction", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.CursorClick24, "FWScrollViewer FWScrollBar FWSwipeControl FWGridSplitter scrolling scroll viewer scroll bar auto hide offset swipe reveal execute archive delete grid splitter resize keyboard drag increment material liquid glass interaction", IsUpdated: true, SourcePath: "/Interaction/FWScrollViewer", BaseClasses: ["ScrollViewer", "ScrollBar", "SwipeControl", "GridSplitter", "Control"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWScrollViewer", "FWScrollBar", "FWSwipeControl", "FWGridSplitter", "FWScroller", "FWRefreshContainer", "FWAnnotatedScrollBar"], SampleCodeKey: "interaction.scrollviewer.swipe.splitter"),
        Entry("inputandmedia", GalleryNavigationGroup.LayoutAndMedia, FluentIconRegular.Color24, "FWColorPicker FWInkCanvas FWInkPresenter FWMediaElement FWWebView FWWebViewDiagnostics color picker alpha hex compact spectrum ink canvas draw erase taper stroke presenter media element play pause stop mute stretch playback webview web view webview2 browser html navigate diagnostics material liquid glass", IsUpdated: true, SourcePath: "/InputMedia/FWColorPicker", BaseClasses: ["Control", "Canvas", "MediaElement", "WebView"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWColorPicker", "FWInkCanvas", "FWInkPresenter", "FWMediaElement", "FWWebView", "FWWebViewDiagnostics"], SampleCodeKey: "inputmedia.color.ink.media"),
        Entry("collections", GalleryNavigationGroup.CollectionsAndData, FluentIconRegular.Table24, "FWListBox FWListView FWGridView FWGridViewItem FWTreeView FWDataGrid FWTreeDataGrid FWProgressBar table list data grid gridview hierarchy selection empty loading grouped group rows density compact high-density state matrix material liquid glass row height headers WinUI GridView", IsUpdated: true, SourcePath: "/Collections/CollectionStates", BaseClasses: ["ListBox", "ListView", "ListViewItem", "GridView", "DataGrid"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWListBox", "FWListBoxItem", "FWListView", "FWListViewItem", "FWGridView", "FWGridViewItem", "FWTreeView", "FWTreeViewItem", "FWDataGrid", "FWTreeDataGrid", "FWProgressBar"], SampleCodeKey: "collections.gridview"),
        Entry("advancedcollections", GalleryNavigationGroup.CollectionsAndData, FluentIconRegular.AppFolder24, "FWItemsRepeater FWItemsRepeaterDiagnostics FWScroller items repeater viewport scroll source range realization recycling diagnostics layout stack grid cache estimated item extent advanced collections first wave", GalleryPageStatus.Preview, IsNew: true, SourcePath: "/Collections/FWItemsRepeater", BaseClasses: ["Panel", "FrameworkElement"], ApiNamespace: "FluentJalium.Controls", RelatedControls: ["FWItemsRepeater", "FWItemsRepeaterDiagnostics", "FWScroller", "FWScrollViewer", "FWListView", "FWTreeView", "FWDataGrid"], SampleCodeKey: "advancedcollections.itemsrepeater"),
        ...
        Entry("controlgapmatrix", GalleryNavigationGroup.Diagnostics, FluentIconRegular.DocumentBulletList24, "control gap matrix backlog WinUI WPFUI UI.WPF.Modern FluentAvalonia Community Toolkit FW public recipe evaluate rendered QA diagnostics first wave second wave", GalleryPageStatus.Diagnostic, IsFooter: true, IsUpdated: true, SourcePath: "/GalleryDiagnostics/ControlGapMatrix", BaseClasses: ["GalleryControlGapEntry", "GalleryControlGapSnapshot"], ApiNamespace: "FluentJalium.Gallery.Models", RelatedControls: ["GalleryControlGapCatalog", "GalleryControlGapEntry", "GalleryControlGapSnapshot"], SampleCodeKey: "diagnostics.controlgap.matrix"),
        Entry("visualqacoverage", GalleryNavigationGroup.Diagnostics, FluentIconRegular.DataUsage24, "visual qa coverage state evidence sample key diagnostics family normal hover pressed selected disabled focus density light dark high contrast material Fluent Design System Gallery metadata", GalleryPageStatus.Diagnostic, IsFooter: true, IsUpdated: true, SourcePath: "/GalleryDiagnostics/VisualQaCoverage", BaseClasses: ["GalleryVisualQaCoverageFamily", "GalleryVisualQaCoverageSnapshot"], ApiNamespace: "FluentJalium.Gallery.Models", RelatedControls: ["GalleryVisualQaCoverageCatalog", "GalleryVisualQaCoverageFamily", "GalleryVisualQaCoverageSnapshot"], SampleCodeKey: "diagnostics.visualqa.coverage"),
