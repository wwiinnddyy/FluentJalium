...
internal sealed class GalleryLocalizationService
{
    ...
    private static Dictionary<string, Dictionary<string, string>> CreateLocalizedText()
    {
        ...
        AddPage(text, "disclosure", "Disclosure", "披露", "Expander, ToolTip, TeachingTip, ContentDialog, and GroupBox controls with target placement, command states, and LiquidGlass disclosure panels.", "Expander、ToolTip、TeachingTip、ContentDialog 和 GroupBox 的目标定位、命令状态与 LiquidGlass 披露面板。", "disclosure expander tooltip teachingtip dialog groupbox 披露 展开 提示 教学提示 对话框 分组");
