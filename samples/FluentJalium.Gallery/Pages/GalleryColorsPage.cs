...
internal sealed class GalleryColorsPage
{
    ...
    private static string CreateSampleCode(string title)
    {
        return title switch
        {
            "Accent states" => "Background=\"{ThemeResource AccentFillColorDefaultBrush}\"\nBorderBrush=\"{ThemeResource AccentBrushHover}\"",
            "Text and fills" => "Foreground=\"{ThemeResource TextFillColorPrimaryBrush}\"\nBackground=\"{ThemeResource ControlFillColorDefaultBrush}\"",
            _ => "SelectionBackground=\"{ThemeResource SelectionBackgroundWeak}\"\nForeground=\"{ThemeResource HyperlinkForeground}\""
        };
    }
