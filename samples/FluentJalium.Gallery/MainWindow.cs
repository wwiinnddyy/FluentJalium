...
public sealed class MainWindow : Window
{
    ...
    private GalleryPage[] CreateGalleryPages()
    {
        ...
        [
            ...
            new GalleryPage("Materials and Effects", "Window backdrops, backdrop effects, and WinUI-style material layering for FluentJalium surfaces.", GalleryNavigationGroup.AppStructure, FluentIconRegular.TransparencySquare24, () => CreatePageStack(new GalleryMaterialsPage(this).CreateContent()), "WindowBackdropType SystemBackdrop Mica MicaAlt Acrylic BackdropEffect BlurEffect AcrylicEffect MicaEffect FrostedGlassEffect DropShadowEffect material layer reveal"),
